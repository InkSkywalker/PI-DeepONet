...
class Brain:
            ...
            if i % self.print_every == 0 or i == self.iterations:
                ...
                if self.save == False:
                    ...
                    if self.save == 'all':
                        ...
                        torch.save(self.net.state_dict(), 'model/model{}.pth'.format(i))
                    else:
                        ...
                        if loss_history[-1][index_temp] < loss_history[best_model_index][index_temp] or len(loss_history) == 1:
                            ...
                            torch.save(self.net.state_dict(), 'model/model_best.pth')
    ...
    def restore(self):
        if self.loss_history is not None and self.save != False:
            ...
            path = 'model/model{}.pth'.format(iteration) if self.save == 'all' else 'model/model_best.pth'
    ...
    def output(self, data, best_model, loss_history, info, path, **kwargs):
        ...
        if best_model:
            ...
            torch.save(self.best_model.state_dict(), path + '/model_best.pth')
        if loss_history:
