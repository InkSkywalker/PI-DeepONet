...
class DeepON(ln.nn.Algorithm):
    ...
    def criterion(self, X, yy):
        ...
        g_1 = grad(u,zz)
        u_Tx,u_Ty,u_Tz = g_1[:,0,0],g_1[:,0,1],g_1[:,0,2]
        u_Px,u_Py,u_Pz = g_1[:,1,0],g_1[:,1,1],g_1[:,1,2]
        u_Xspdx, u_Xspdy, u_Xspdz  = g_1[:,2,0],g_1[:,2,1],g_1[:,2,2]
        u_Yspdx, u_Yspdy, u_Yspdz  = g_1[:,3,0],g_1[:,3,1],g_1[:,3,2]
        u_Zspdx, u_Zspdy, u_Zspdz  = g_1[:,4,0],g_1[:,4,1],g_1[:,4,2]
